# 0. ================================== СОДЕРЖАНИЕ МОДУЛЯ DEBUG ====================================
# I. ИМПОРТ БИБЛИОТЕК, ФУНКЦИЙ И МОДУЛЕЙ ПРОЕКТА
# II. ФУНКЦИИ - ОБЁРТКИ ДЛЯ ВЫЗОВА ФУНКЦИЙ МОДУЛЕЙ
# III. ЗАПУСК КАЖДОЙ ФУНКЦИИ ИЗ МОДУЛЕЙ ДЛЯ РУЧНОГО ТЕСТИРОВАНИЯ
...
# II. ========================== ФУНКЦИИ - ОБЁРТКИ ДЛЯ ВЫЗОВА МОДУЛЕЙ ==============================
# 0. Модуль masks:
...
# 8. Модуль search:
# 8.1 Функция process_bank_search.
def run_process_bank_search() -> None:
    """
...
# 8.2 Функция process_bank_operations.
def run_process_bank_operations() -> None:
    """
    Обёртка для функции process_bank_operations из модуля search.
    """
    data = get_transactions_from_json_file("data/operations.json")
...
if __name__ == "__main__":
    ...
    try:
        print(" ")
        print("Результа�� работы функции transaction_descriptions:")
        for _ in range(5):
    ...
    # 5.1 Вызов get_transactions_from_file, которая принимает данные из файла и возвращает список словарей
    # с транзакциями.
    print("\n------ Модуль utils ------ :")
    ...
    # 7.1 Вызов функции run_get_transaction_from_csv_file, которая принимает данные из файла и возвращает список
    ...
    # 7.2 Вызов функции run_get_transaction_from_excel_file, которая принимает данные из файла и возвращает
    ...
    # 8. ------------------ Запуск функций модуля search ---------------------:
    print("\n------ Модуль search ------ :")
    print("Результат работы функции process_bank_search:")
    run_process_bank_search()

    print(" ")
    print("Результат работы функции process_bank_operations:")
    run_process_bank_operations()
