...
def test_transaction_descriptions_diff_length_data() -> None:
    ...
    empty_data: List[Dict] = []
    descriptions: Iterator[str] = transaction_descriptions(empty_data)
    ...
    descriptions: Iterator[str] = transaction_descriptions(short_data)
    ...
    descriptions: List[str] = list(transaction_descriptions(long_data))
